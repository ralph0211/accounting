<%@ Page Title="" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="Cashbook.aspx.vb" Inherits="Accounting_Cashbook" %>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 center-block">
                    <asp:GridView ID="grdDetails0" runat="server" EnableModelValidation="True" HorizontalAlign="Center">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 control-label">
                    <asp:Label ID="Label1223" runat="server" Text="Type"></asp:Label>
                </div>
                <div class="col-xs-4">
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <asp:RadioButtonList ID="rdbPayType" runat="server" CssClass="col-xs-12 control-label" RepeatDirection="Horizontal">
                        <asp:ListItem Value="211/1">Cash</asp:ListItem>
                        <asp:ListItem Value="212/1">Bank</asp:ListItem>
                    </asp:RadioButtonList>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xs-4">
                    <asp:DropDownList CssClass="col-xs-12 form-control input-sm chosen" ID="cmbAccount0" runat="server">
                    </asp:DropDownList>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-2 control-label">
                    ...
                    <br />
                    <br />
                    <asp:Label ID="Label1222" runat="server" Text="Received From"></asp:Label>
                </div>
                <div class="col-xs-4">
                    <asp:DropDownList CssClass="col-xs-12 form-control input-sm chosen" ID="cmbAccount1" runat="server" AutoPostBack="True" Visible="False">
                    </asp:DropDownList>
                    <br />
                    <br />
                    <asp:TextBox CssClass="col-xs-12 form-control input-sm" ID="txtRecFrom" runat="server"></asp:TextBox>
                </div>
                <div class="col-xs-2 control-label">
