...
Partial Class Accounting_rptaccountStatementGroup
    ...
    Protected Sub printAccStmt()
        Try
            ...
            cmd = New SqlCommand("select isnull(Sum(isnull(Debit,0)) - SUM(isnull(Credit,0)),0) as Bbfwd from Accounts_Transactions a where [GroupAccNo]='" & Session("AccNo").ToString & "' and TrxnDate<'" & Session("DateFrom").ToString & "' and Account=a.DebtorAccNo", con)
