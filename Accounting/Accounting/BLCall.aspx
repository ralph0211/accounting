<%@ Page Title="Balance Sheet" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="BLCall.aspx.vb" Inherits="Accounting_BLCall" %>
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-xs-2 control-label">
                    <asp:Label ID="Label1221" runat="server" Text=" As at Date"></asp:Label>
                </div>
                <div class="col-xs-4">
