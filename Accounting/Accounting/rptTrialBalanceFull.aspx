<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rptTrialBalanceFull.aspx.vb" Inherits="Accounting_rptTrialBalanceFull" %>
                            ...
                            <asp:GridView ID="grdDetails" runat="server" BackColor="White" ShowFooter="true" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Names="Calibri" Font-Size="11pt" ForeColor="Black" GridLines="None" Width="1291px" AutoGenerateColumns="false">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Description">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink1" runat="server" Target="_blank" Text='<%# Eval("Description")%>' NavigateUrl='<%# "~/Accounting/rptAccStmtSchedule.aspx?acc=" + Eval("AccNo") + "&dat=" + lblDateFrom.Text %>' ToolTip="Click to view full schedule"></asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
