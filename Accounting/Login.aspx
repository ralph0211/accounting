...
<body class="login-screen-bg">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <div class="container">
            <%--<asp:Panel ID="Panel1" runat="server" DefaultButton="btn_Login" Width="100%">--%>
                <div class="row vertical-center-row">
                    <div class="col-md-4 col-center-block login-widget">
                        ...
                        <br />
                        <div>
                        <div class="row" style="height: 0px; padding-left: 30px;">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="txt_UserId" runat="server" class="form-control input-lg" placeholder="Username" type="text" autocomplete="off" onkeypress="return EnterEvent(event)">
                                </div>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input id="txt_Password" runat="server" class="form-control input-lg" placeholder="Password" type="password" autocomplete="off" onkeypress="return EnterEvent(event)">
                                </div>
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                ...
                                <asp:Button ID="btn_Login" runat="server" Text="Login" CssClass="btn btn-primary btn-block btn-lg" UseSubmitBehavior="false" />
                                <hr>
                            </div>
