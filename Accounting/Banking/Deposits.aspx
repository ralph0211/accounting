<%@ Page Title="Cash Deposit" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="Deposits.aspx.vb" Inherits="Banking_Deposits" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel panel-primary small">
        <div class="panel-heading">
            <h4 class="panel-title">Cash Deposit
            </h4>
        </div>
        <div class="panel-body">
            <div class="row label-info control-label">
                <div class="col-xs-12">Deposits</div>
            </div>
            <div class="row">
                ...
                <div class="col-xs-2 control-label">
                    Bank Balance:&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblBankBalance" runat="server" Text=""></asp:Label>
                </div>
                <div class="col-xs-2 control-label">
                    <asp:Label ID="lblBankAccNo" runat="server" Text="" Visible="false"></asp:Label>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-2 control-label">
                ...
                <div class="col-xs-4">
                    <asp:DropDownList ID="cmbBranchAccount" runat="server" CssClass="col-xs-12 form-control input-sm chosen"></asp:DropDownList>
                </div>
                <%--<div class="col-xs-2 control-label">
                    Transaction Type
                </div>
