<%@ Page Title="Withdrawal" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="fundsReturn.aspx.vb" Inherits="Banking_Withdrawals" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel panel-primary small">
        <div class="panel-heading">
            <h4 class="panel-title">Returns
            </h4>
        </div>
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-2 control-label">
                    Return To (Branch Account)
                </div>
                <div class="col-xs-4">
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <asp:DropDownList ID="cmbLoanOfficerAccount" runat="server" CssClass="col-xs-12 form-control input-sm chosen" AutoPostBack="True"></asp:DropDownList>
                </div>
                <div class="col-xs-2 control-label">
                    Loan Officer Balance:&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="LblLoanOfficerBal" runat="server" Text=""></asp:Label>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-2 control-label">
                ...
                <div class="col-xs-4">
                    <asp:TextBox ID="txtAmount" runat="server" CssClass="col-xs-12 form-control input-sm numeric" Enabled="False" ReadOnly="True"></asp:TextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-2 control-label">
