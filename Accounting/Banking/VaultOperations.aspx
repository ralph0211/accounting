<%@ Page Title="Vault Operations" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="VaultOperations.aspx.vb" Inherits="Banking_VaultOperations" %>
    ...
    <div class="panel panel-primary small">
        ...
        <div class="panel-body">
            <div class="row alert-info">
                ...
                <div class="col-xs-2 control-label">
                    <asp:Label ID="lblVaultBalance" runat="server" Text=""></asp:Label>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-2 control-label">
                ...
                <div class="col-xs-4">
                    <asp:Label ID="lblVaultAccNo" runat="server" Text=""></asp:Label>
                </div>
                <div class="col-xs-2 control-label">
                    Transaction Type
                </div>
                <div class="col-xs-4">
                    <asp:RadioButtonList ID="rdbTransactionType" runat="server" CssClass="col-xs-12 input-sm" RepeatDirection="Horizontal">
                        <asp:ListItem Text="Deposit into Vault" Value="Deposit"></asp:ListItem>
                        <asp:ListItem Text="Withdraw from Vault" Value="Withdrawal"></asp:ListItem>
                    </asp:RadioButtonList>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xs-4">
                    <asp:TextBox ID="txtAmount" runat="server" CssClass="col-xs-12 form-control input-sm"></asp:TextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-2 control-label">
