...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
                ...
                <div class="page-content">
                    ...
                    <div class="row page-toolbar">
                        <div id="dashboard-report-range" class="pull-right tooltips btn btn-fit-height green" data-placement="top" data-original-title="Change dashboard date range">
                            ...
                            <span class="thin uppercase hidden-xs" runat="server" id="dashboardReportRange"></span>&nbsp;
                            <asp:HiddenField ID="hidDateRange" runat="server" />
                            <i class="fa fa-angle-down"></i>
                        </div>
                    </div>
                    <div style="height: 20px;"></div>
                    <div class="row">
                        <a href="Credit/ApplicationView.aspx" id="divInc" runat="server">
                                    ...
                                    <div class="display">
                                        <div class="number">
                                            ...
                                            <small class="font-dark">
                                                <asp:Label ID="lblIncomingApps" runat="server" Text="INCOMING APPLICATIONS"></asp:Label></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="display">
                                        <div class="number">
                                            <h4 class=" font-yellow-lemon  bold">
                                                <small class="font-yellow-lemon">$</small>
                    ...
                    <div class="row">
                        <a href="Reports/xrptArrears.aspx" target="_new">
                            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                <div class="dashboard-stat green-dark">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            $<span data-counter="counterup" data-value="<%= lblGreen.Text%>">0</span>
                                            <asp:Label ID="lblGreen" runat="server" Text="0" Visible="false"></asp:Label>
                                        </div>

                                        <div class="desc">
                                            <asp:Label ID="lblGreenCount" runat="server" Text="0" Font-Bold="true"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;Unexpired Balance
                                        </div>
                                    </div>
                                    <a class="more" href="Reports/xrptArrears.aspx" target="_new">View full detailed report
                        ...
                        <a href="Reports/xrptArrears.aspx" target="_new">
                            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                <div class="dashboard-stat green">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            $<span data-counter="counterup" data-value="<%= lblYellow.Text%>">0</span>
                                            <asp:Label ID="lblYellow" runat="server" Text="0" Visible="false"></asp:Label>
                                        </div>

                                        <div class="desc">
                                            <asp:Label ID="lblYellowCount" runat="server" Text="0" Font-Bold="true"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;1 - 30 days Overdue
                                        </div>
                                    </div>
                                    <a class="more" href="Reports/xrptArrears.aspx" target="_new">View full detailed report
                                        <i class="m-icon-swapright m-icon-white"></i>
                        ...
                        <a href="Reports/xrptArrears.aspx" target="_new">
                            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                <div class="dashboard-stat yellow-mint">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            $<span data-counter="counterup" data-value="<%= lblRed.Text%>">0</span>
                                            <asp:Label ID="lblRed" runat="server" Text="0" Visible="false"></asp:Label>
                                        </div>

                                        <div class="desc">
                                            <asp:Label ID="lblRedCount" runat="server" Text="0" Font-Bold="true"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;31 -60 days Overdue
                                        </div>
                                    </div>
                                    <a class="more" href="Reports/xrptArrears.aspx" target="_new">View full detailed report
                                        <i class="m-icon-swapright m-icon-white"></i>
                        ...
                        <a href="Reports/xrptArrears.aspx" target="_new">
                            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                <div class="dashboard-stat yellow-lemon">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            $<span data-counter="counterup" data-value="<%= lbl60.Text%>">0</span>
                                            <asp:Label ID="lbl60" runat="server" Text="0" Visible="false"></asp:Label>
                                        </div>

                                        <div class="desc">
                                            <asp:Label ID="lbl60Count" runat="server" Text="0" Font-Bold="true"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;61 - 90 days Overdue
                                        </div>
                                    </div>
                                    <a class="more" href="Reports/xrptArrears.aspx" target="_new">View full detailed report
                                        <i class="m-icon-swapright m-icon-white"></i>
                        ...
                        <a href="Reports/xrptArrears.aspx" target="_new">
                            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                <div class="dashboard-stat red-pink">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            $<span data-counter="counterup" data-value="<%= lbl90.Text%>">0</span>
                                            <asp:Label ID="lbl90" runat="server" Text="0" Visible="false"></asp:Label>
                                        </div>

                                        <div class="desc">
                                            <asp:Label ID="lbl90Count" runat="server" Text="0" Font-Bold="true"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;91 - 180 days Overdue
                                        </div>
                                    </div>
                                    <a class="more" href="Reports/xrptArrears.aspx" target="_new">View full detailed report
                                        <i class="m-icon-swapright m-icon-white"></i>
                        ...
                        <a href="Reports/xrptArrears.aspx" target="_new">
                            <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                <div class="dashboard-stat red-intense">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            $<span data-counter="counterup" data-value="<%= lbl180.Text%>">0</span>
                                            <asp:Label ID="lbl180" runat="server" Text="0" Visible="false"></asp:Label>
                                        </div>

                                        <div class="desc">
                                            <asp:Label ID="lbl180Count" runat="server" Text="0" Font-Bold="true"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;Over 180 days Overdue
                                        </div>
                                    </div>
                                    <a class="more" href="Reports/xrptArrears.aspx" target="_new">View full detailed report
                                        <i class="m-icon-swapright m-icon-white"></i>
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject bold uppercase font-green-haze">Sector Analysis</span>
                                        <span class="caption-helper">disbursed loans by value</span>
                                    </div>
                                    <div class="tools">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-bar-chart font-green-haze"></i>
                                        <span class="caption-subject bold uppercase font-green-haze">Branch Analysis</span>
                                        <span class="caption-helper">disbursed loans by value</span>
                                    </div>
                                    <div class="tools">
                                        <a href="javascript:;" class="collapse"></a>
                                ...
                                <div class="portlet-body">
                                    <div id="branchChart" class="chart" style="height: 300px;"></div>
                                    <%--<div class="well margin-top-20">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <label class="text-left">Top Radius:</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-bar-chart font-green-haze"></i>
                                        <span class="caption-subject bold uppercase font-green-haze">Loan Officer Analysis</span>
                                        <span class="caption-helper">disbursed loans by value</span>
                                    </div>
                                    <div class="tools">
                                        <a href="javascript:;" class="collapse"></a>
                                ...
                                <div class="portlet-body">
                                    <div id="loanOfficerChart" class="chart" style="height: 300px;"></div>
                                    <%--<div class="well margin-top-20">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <label class="text-left">Top Radius:</label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-bar-chart font-green-haze"></i>
                                        <span class="caption-subject bold uppercase font-green-haze">Product Analysis</span>
                                        <span class="caption-helper">disbursed loans by value</span>
                                    </div>
                                    <div class="tools">
                                        <a href="javascript:;" class="collapse"></a>
                                ...
                                <div class="portlet-body">
                                    <div id="productChart" class="chart" style="height: 300px;"></div>
                                    <%--<div class="well margin-top-20">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <label class="text-left">Top Radius:</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-bar-chart font-green-haze"></i>
                                        <span class="caption-subject bold uppercase font-green-haze">Loan Purpose Analysis</span>
                                        <span class="caption-helper">disbursed loans by value</span>
                                    </div>
                                    <div class="tools">
                                        <a href="javascript:;" class="collapse"></a>
                                ...
                                <div class="portlet-body">
                                    <div id="loanPurposeChart" class="chart" style="height: 300px;"></div>
                                    <%--<div class="well margin-top-20">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <label class="text-left">Top Radius:</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <div id="lOChart" class="chart" style="height: 300px;"></div>
                                    <%--<div class="well margin-top-20">
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <label class="text-left">Top Radius:</label>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-red">
                                        ...
                                        <span class="caption-helper">month by month analysis (amount)</span>
                                    </div>
                                    <%--<div class="actions">
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        <span class="caption-subject bold uppercase">Disbursements/Repayments</span>
                                        <span class="caption-helper">number of transactions monthly analysis</span>
                                    </div>
                                    <%--<div class="actions">
    ...
    <![endif]-->
        ...
        <script type="text/javascript">
            ...
            //    $.ajax({
            //        url: "DashboardData.asmx/GetMonthlyData",
            //        data: {},
            ...
            //});
            $(document).ready(function () {
                var sess='<%= Session("DASHBOARD")%>';
                var user='<%= Session("UserId")%>';
                var branch='<%= Session("BRANCHCODE")%>';
                $.ajax({
                    url: "DashboardData.asmx/GetWeeklyData",
                    type: 'POST',
                    //data: JSON.stringify({ 'role': sess.toString(), 'userId': user.toString() }),
                    //data: jQuery.param({ role: sess, userId: user }),
                    //data: jQuery.param({ 'role': sess.toString(), 'userId': 'loan' }),
                    data: JSON.stringify({ dashView: sess.toString(),brnc:branch, userId: user }),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (chartData) {
                        //debugger;
                        var chart = AmCharts.makeChart("dataChart", {
                            ...
                            "graphs": [{
                                "alphaField": "alpha",
                                "balloonText": "<span style='font-size:12px;'>[[title]] for month [[category]]:<br><span style='font-size:20px;'>[[value]]</span> [[additional]]</span>",
                                "fillAlphas": 1,
                                "title": "Value of Disbursements",
                                "type": "column",
                                "valueField": "DisbAmt"
            ...
            $(document).ready(function () {
                initChartSample7();
                initLoanPurposeChart();
                initLoanOfficerChart();
                initProductChart();
                initPurposeChart();
            });
            ...
            var initChartSample7 = function () {
                $.ajax({
                    url: "DashboardData.asmx/GetSectorAnalysis",
                    data: {},
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (chartData) {
                        var chart = AmCharts.makeChart("chart_7", {
                            ...
                            "dataProvider": JSON.parse(chartData.d),
                            "valueField": "SumSector",
                            "titleField": "LOAN_SECTOR",
                            "outlineAlpha": 0.4,
                            "depth3D": 15,
            ...
            var initLoanPurposeChart = function () {
                $.ajax({
                    url: "DashboardData.asmx/GetBranchAnalysis",
                    data: {},
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (chartData) {
                        var chart = AmCharts.makeChart("branchChart", {
                            "type": "pie",
                            "theme": "light",
            ...
            var initLoanOfficerChart = function () {
                $.ajax({
                    url: "DashboardData.asmx/GetLoanOfficerAnalysis",
                    data: {},
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (chartData) {
                        var chart = AmCharts.makeChart("loanOfficerChart", {
                            "type": "pie",
                            "theme": "light",
            ...
            var initProductChart = function () {
                $.ajax({
                    url: "DashboardData.asmx/GetProductAnalysis",
                    data: {},
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (chartData) {
                        var chart = AmCharts.makeChart("productChart", {
                            "type": "pie",
                            "theme": "light",
            ...
            var initPurposeChart = function () {
                $.ajax({
                    url: "DashboardData.asmx/GetLoanPurposeAnalysis",
                    data: {},
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (chartData) {
                        var chart = AmCharts.makeChart("loanPurposeChart", {
                            "type": "pie",
                            "theme": "light",
