        ...
        <div id="collapse-one" class="panel-collapse collapse in">
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <strong class="hidden">CASH BOX</strong>
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="hidden" Font-Size="Large" Font-Bold="true" Style="text-align: center" Enabled="False" Height="45px" Width="436px"></asp:TextBox>
                </div>
                <div class="row">
                    <div class="col-xs-2 control-label">
                        Applicant Category
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <asp:TextBox ReadOnly="True" ForeColor="Black" Font-Bold="true" CssClass="col-xs-12 form-control input-sm" ID="txtRecAmt" runat="server"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-2 control-label">
                ...
                <div class="row alert-info">
                    <div class="col-xs-12 control-label">
                        <asp:Label ID="lblProductFee" runat="server" Text=""></asp:Label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-2 control-label">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <asp:RadioButtonList ID="rdbFinReqDisburseOption" runat="server" RepeatDirection="horizontal" CssClass="col-xs-12">
                            <asp:ListItem Text="Cash" Value="Cash"></asp:ListItem>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <asp:TextBox Font-Bold="true" CssClass="col-xs-12 form-control input-sm numeric" ID="txtUpfrontFees" runat="server" AutoPostBack="true"></asp:TextBox>
                    </div>
                </div>
                <div class="row hidden">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <asp:TextBox ReadOnly="True" ForeColor="Black" Font-Bold="true" CssClass="col-xs-12 form-control input-sm" ID="txtAmtToDisburse" runat="server" Enabled="false"></asp:TextBox>
                    </div>
                    <div class="col-xs-2 control-label">
                ...
                <div class="row">
                    <div class="col-xs-2 control-label">
                        Upfront Fees Account
                    </div>
                    <div class="col-xs-4">
                        <asp:DropDownList CssClass="col-xs-12 form-control input-sm chosen" ID="cmbUpfrontFeesAccount" runat="server">
                        </asp:DropDownList>
                    </div>
                    <div class="col-xs-2 control-label">
                ...
                <div class="row">
                    <div class="col-xs-2 control-label">
                        <asp:Label ID="Label4" runat="server" Text="First Payment Date"></asp:Label>
                    </div>
                    <div class="col-xs-4">
                        <asp:TextBox CssClass="col-xs-12 form-control input-sm datepicker" ID="txtFirstPayDate" runat="server"></asp:TextBox>
                        <span class="glyphicon glyphicon-calendar form-control-feedback" style="margin-right: 13px; background-color: #eeeeff; border-radius: 0 3px 3px 0; border: 1px solid rgb(149,188,219); z-index: 0;"></span>
                    </div>
                    <div class="col-xs-2 control-label">
                        Voucher Number
                    ...
                    <div class="col-xs-4">
                        <asp:TextBox CssClass="col-xs-12 form-control input-sm" ID="txtVoucherNo" runat="server"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <asp:Button ID="btnDisburse" runat="server" CssClass="btn btn-primary btn-sm btn-save" Text="Disburse" UseSubmitBehavior="false" />
                        <asp:Button ID="btnReject" runat="server" CssClass="btn btn-danger btn-sm" Text="Reject" UseSubmitBehavior="false" Visible="false" />
                    </div>
                </div>
            </div>
        </div>
