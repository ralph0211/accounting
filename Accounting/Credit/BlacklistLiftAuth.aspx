<%@ Page Title="Authorize lifting of Blacklist" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="BlacklistLiftAuth.aspx.vb" Inherits="QuestCredit_BlacklistLiftAuth" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel panel-primary small">
        <div class="panel-heading">
            <h4 class="panel-title">Authorize Uplift Blacklisted Client
            </h4>
        </div>
                            ...
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False"
                                        CommandArgument='<%#Eval("id")%>' CommandName="Uplift" Text="Authorize"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False"
                                        CommandArgument='<%#Eval("id")%>' CommandName="Discard" Text="Discard"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
