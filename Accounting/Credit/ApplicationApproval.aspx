<%@ Page Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="ApplicationApproval.aspx.vb" Inherits="Credit_ApplicationApproval" Title="Application Approval - Credit Management System" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="panel-body">
            <div class="row label-info">
                <div class="col-xs-12 control-label">
                    <asp:Label ID="Label18" runat="server" Text="APPLICATION HISTORY"></asp:Label>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div id="Tabs" role="tabpanel">
                        ...
                        <div class="tab-content">
                            <div id="applicant" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        <asp:TextBox ReadOnly="True" ForeColor="Black" Font-Bold="true" CssClass="col-xs-12 form-control input-sm" ID="txtIDNo" runat="server" data-toggle="tooltip" data-placement="top" ToolTip="Valid format: 01-2345678A90"></asp:TextBox>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        <asp:TextBox ReadOnly="True" ForeColor="Black" Font-Bold="true" Enabled="false" ID="bdpDOB" runat="server" CssClass="col-xs-12 form-control input-sm dob"></asp:TextBox>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        <asp:TextBox ReadOnly="True" ForeColor="Black" Font-Bold="true" Enabled="false" ID="bdpIssDate" runat="server" CssClass="col-xs-12 form-control input-sm nofuturedate"></asp:TextBox>
                                        <span class="glyphicon glyphicon-calendar form-control-feedback" style="margin-right: 13px; background-color: #eeeeff; border-radius: 0 3px 3px 0; border: 1px solid rgb(149,188,219); z-index: 0;"></span>
                                    </div>
                                    <div class="col-xs-2 control-label">
                            ...
                            <div id="financial" class="tab-pane fade in">
                                ...
                                <div class="row hidden">
                                    ...
                                    <div class="col-xs-4">
                                        <asp:RadioButtonList ReadOnly="True" ForeColor="Black" Font-Bold="true" Enabled="false" ID="rdbType" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" Style="margin-right: 0px; margin-left: 0px;" Width="212px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-2 control-label">
                                        <asp:Label ID="Label12" runat="server" Text="1st Repayment Date"></asp:Label>
                                    </div>
                                    <div class="col-xs-4">
                                ...
                                <div class="row hidden">
                                    ...
                                    <div class="col-xs-4">
                                        <asp:RadioButtonList ReadOnly="True" ForeColor="Black" Font-Bold="true" Enabled="false" ID="rdbFinReqDisburseOption" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" CssClass="col-xs-12 text-center">
                                            <asp:ListItem Text="Cash" Value="Cash"></asp:ListItem>
                                ...
                                <div class="row label-info">
                                    <div class="col-xs-12 control-label">
                                        <asp:Label ID="Label19" runat="server" Text="QUESTIONNAIRE & RECOMMENDATION"></asp:Label>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <asp:RadioButtonList ReadOnly="True" ForeColor="Black" Font-Bold="true" Enabled="false" ID="rdbQuesHow" runat="server" CssClass="col-xs-12"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        <asp:TextBox ReadOnly="True" ForeColor="Black" Font-Bold="true" Enabled="false" ID="txtApplicationDate" runat="server" CssClass="col-xs-12 form-control input-sm nofuturedate"></asp:TextBox>
                                        <span class="glyphicon glyphicon-calendar form-control-feedback" style="margin-right: 13px; background-color: #eeeeff; border-radius: 0 3px 3px 0; border: 1px solid rgb(149,188,219); z-index: 0;"></span>
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <asp:TextBox ReadOnly="True" ForeColor="Black" Font-Bold="true" Enabled="false" CssClass="col-xs-12 form-control input-sm nofuturedate" ID="txtDisburseDate" runat="server" Visible="False"></asp:TextBox>
                                <span class="glyphicon glyphicon-calendar form-control-feedback" style="margin-right: 13px; background-color: #eeeeff; border-radius: 0 3px 3px 0; border: 1px solid rgb(149,188,219);" runat="server" id="spanDDate" visible="false"></span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 text-center">
                        ...
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                <asp:CheckBox ID="chkPartial" runat="server" Text="Partial Disbursement" AutoPostBack="true" Font-Bold="true" Visible="false" />
                            </div>
                        </div>
                        <div class="row" id="modalDisburse" runat="server" visible="false">
                            <div class="col-xs-2 control-label">
                                Amount to Disburse
                            </div>
                            <div class="col-xs-4">
                                <asp:TextBox ReadOnly="True" ForeColor="Black" Font-Bold="true" Enabled="false" CssClass="col-xs-12 form-control input-sm" ID="txtAmtToDisburse" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-xs-2">
                                <asp:Button CssClass="btn btn-primary btn-sm" ID="btnDisburse" runat="server" Text="Disburse" OnClick="btnDisburse_Click" Visible="false" />
                            </div>
                        </div>
                        <div class="row" id="disbRow" runat="server" visible="false">
                            <div class="col-xs-2 control-label">
                                Disbursement Option
                            </div>
                            <div class="col-xs-4">
                                <asp:RadioButtonList ID="rdbDisbursementOption" runat="server" AutoPostBack="true" RepeatDirection="horizontal" CssClass="col-xs-12">
                                    <asp:ListItem Text="Cash" Value="Cash"></asp:ListItem>
                                    <asp:ListItem Text="RTGS" Value="RTGS"></asp:ListItem>
                                    <asp:ListItem Text="Mobile wallet" Value="Mobile"></asp:ListItem>
                        ...
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                <asp:DropDownList CssClass="col-xs-12 form-control input-sm" ID="cmbBanks" runat="server" Visible="False">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="row hidden">
                            <div class="col-xs-12 text-center">
                                <asp:CheckBox ID="chkInsiderLoan" runat="server" Text="Insider Loan" Font-Bold="true" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-2 control-label">
                            ...
                            <div class="col-xs-4">
                                <asp:DropDownList ID="cmbOwner" CssClass="col-xs-12 input-sm form-control" runat="server" Enabled="false"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 text-center">
                        ...
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                <asp:Label ID="lblTickSSB" runat="server" Text="You must ackowledge receiving Agreement before recommending" Visible="false" ForeColor="Red"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function toggleWarning1() {
            var chkTick = document.getElementById('<%= chkTickSSB.ClientID%>');
            var lblTick = document.getElementById('<%= lblTickSSB.ClientID%>');
            if (chkTick.checked)
            {
        ...
        function toggleWarning() {
            var chkTick = '<%= chkTickSSB.ClientID%>';
            var lblTick = '<%= lblTickSSB.ClientID%>';
            if (<%= chkTickSSB.ClientID%>.checked)
            {
                setTimeout(function () {
                    document.getElementById("<%=lblTickSSB.ClientID%>").style.display = "none";
                }, 0);
                ...
                setTimeout(function () {
                    document.getElementById("<%=lblTickSSB.ClientID%>").style.display = "block";
                }, 0);
                setTimeout(function () {
                    document.getElementById("<%=btnSubmit.ClientID%>").style.display = "none";
                }, 0);
        ...
        <%--$(function () {
            $("#<%= txtDisburseDate.ClientID %>").datepicker({ dateFormat: 'd MM yy' }).val();
            //$("#<%= txtDisburseDate.ClientID %>").datepicker("setDate", new Date());
        });--%>
        function showDisburseAmt() {
            $("#modalDisburse").dialog({
            ...
            //disb.parent().appendTo(jQuery("form:first"));
            return false;
            //});
        }
        ...
        $(function () {
            ...
            $(function () {
                $("[id*=btnSubmit]").bind("click", function () {
                    $("[id*=btnSubmit]").val("Processing...");
                    $("[id*=btnSubmit]").attr("disabled", true);
                    $("[id*=btnReject]").attr("disabled", true);
                });
            });
            $(function () {
                $("[id*=btnReject]").bind("click", function () {
                    $("[id*=btnReject]").val("Processing...");
                    $("[id*=btnReject]").attr("disabled", true);
                    $("[id*=btnSubmit]").attr("disabled", true);
                });
            });
