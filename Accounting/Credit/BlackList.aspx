<%@ Page Title="Client Blacklisting" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="BlackList.aspx.vb" Inherits="QuestCredit_BlackList" %>
        ...
        <div class="panel-body">
            ...
            <asp:Panel ID="panIndividual" runat="server">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <asp:TextBox ID="txtIDNo" runat="server" AutoPostBack="true" CssClass="col-xs-12 form-control input-sm" data-placement="top" data-toggle="tooltip" OnTextChanged="txtIDNo_TextChanged" ToolTip="Valid format: 01-2345678A90" Enabled="false" ReadOnly="true" Font-Bold="true"></asp:TextBox>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <asp:TextBox ID="txtBlacklistReason" runat="server" CssClass="col-xs-12 form-control input-sm" TextMode="MultiLine"></asp:TextBox>
                    </div>
                    <div class="col-xs-2 control-label">
                        Date Blacklisted
                    </div>
                    <div class="col-xs-4">
                        <asp:TextBox ID="txtDateBlacklisted" runat="server" CssClass="col-xs-12 form-control input-sm nofuturedate"></asp:TextBox>
                        <span class="glyphicon glyphicon-calendar form-control-feedback" style="margin-right: 13px; background-color: #eeeeff; border-radius: 0 3px 3px 0; border: 1px solid rgb(149,188,219); z-index: 0;"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <asp:Button CssClass="btn btn-primary btn-sm" ID="btnSaveName" runat="server" Text="Blacklist Client" ValidationGroup="valIndiv"
                            OnClientClick="return isBlacklist(); window.scrollTo = function(x,y) { return true; };" />
            ...
            <asp:Panel ID="pnlFarmers" runat="server" Visible="false">
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <asp:Button CssClass="btn btn-primary btn-sm" ID="btnSaveFarmer" runat="server" Text="Blacklist Client" OnClientClick="return isBlacklist();" />
