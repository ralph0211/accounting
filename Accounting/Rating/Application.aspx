<%@ Page Title="Application Rating" Language="VB" MasterPageFile="~/Site2.master" AutoEventWireup="false" CodeFile="Application.aspx.vb" Inherits="Rating_Application" %>
    ...
    <div class="panel panel-primary small">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-3">
                    <asp:TextBox CssClass="col-xs-12 form-control input-sm" ID="txtSearchName" runat="server" BorderColor="#CCCCCC"
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    <asp:Button CssClass="btn btn-primary btn-sm" ID="btnSaveRating" runat="server" Text="Calculate Rating"
                        Visible="False" />
                    <asp:Button CssClass="btn btn-primary btn-sm" ID="btnSaveScorecard" runat="server" Text="Save Scorecard" />
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 text-center">
