    ...
    <div class="panel panel-primary small">
        ...
        <div class="panel-body">
            ...
            <div class="row" id="divGracePeriod">
                ...
                <div class="col-xs-2">
                    <asp:TextBox CssClass="col-xs-12 form-control input-sm numeric" ID="txtMinGracePerLength" runat="server"></asp:TextBox>
                </div>
                <div class="col-xs-2 control-label">
                    Maximum Grace Period
                </div>
                <div class="col-xs-2">
                    <asp:TextBox CssClass="col-xs-12 form-control input-sm numeric" ID="txtMaxGracePerLength" runat="server"></asp:TextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-3 control-label">
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <asp:RadioButtonList ID="rdbSalaryBasedLimit" CssClass="col-xs-12" RepeatDirection="Horizontal" runat="server">
                        <asp:ListItem Text="Yes" Value="Y"></asp:ListItem>
                        <asp:ListItem Text="No" Value="N"></asp:ListItem>
                    </asp:RadioButtonList>
                </div>
                ...
                <div class="col-xs-4">
                    <asp:RadioButtonList ID="rdbLimitBasedOn" CssClass="col-xs-12" RepeatDirection="Horizontal" runat="server">
                        <asp:ListItem Text="Gross Salary" Value="Gross"></asp:ListItem>
                        <asp:ListItem Text="Net Salary" Value="Net"></asp:ListItem>
                    </asp:RadioButtonList>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-xs-4">
                    <asp:TextBox CssClass="col-xs-12 form-control input-sm numeric" ID="txtLimitMaxRate" runat="server"></asp:TextBox>
                </div>
            </div>
            <div class="row">
